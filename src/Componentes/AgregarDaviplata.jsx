...
import iconD from "../assets/images/Pagos/iconDavi.png"
import botonN from "../assets/images/Pagos/botonN.png"
import { useNavigate } from "react-router-dom"

export const AgregarDaviplata = () => {
    ...
    return (
        ...
        <div>
            <img src={iconD} alt=""  style={{ marginLeft:'160px', marginTop:'-70px', marginBottom:'10px'}}/>
        </div>
        <div className='ms-2'>
